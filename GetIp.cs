...
namespace LSGETIP
{
    internal class GetIp
    {
        ...
        /// 
        /// </summary>
        /// <param name="url">https://wwww.lopessouto.com.br/getip.asp</param>
        /// <param name="nome">notedante</param>
        /// <param name="auth">wrlmaq</param>
        /// <param name="app">ex:'LopesSoutoERP' or ''. Só deve ser informado se quer o endereço para determinado app</param>
                ...
                System.Threading.Tasks.Task doIt = new System.Threading.Tasks.Task(async () =>
                {
                    ...
                    using (var client = new HttpClient())
                    {
                        ...
                        catch (HttpRequestException ex)
                        {
                            ...
                            Console.WriteLine("A resposta HTTP for malsucedida: " + ex.Message);
